...
class CubyPlatform {
    constructor(log, config, api) {
        ...
        this.cubyClient = new Cuby_1.default(this.config.token || '');
        /*
        ...
        api.on("didFinishLaunching" /* APIEvent.DID_FINISH_LAUNCHING */, async () => {
            ...
            this.api.registerPlatformAccessories(consts_1.PLUGIN_NAME, consts_1.PLATFORM_NAME, this.accessories.filter((a) => !this.cachedAccessories.find((ca) => ca.UUID === a.UUID)));
        });
    }
