...
class CubyAirConditionerAccessory {
    ...
    async setActive(value) {
        ...
        try {
            ...
            if (isActive) {
                (_a = this.service
                    .getCharacteristic(this.platform.Characteristic.RotationSpeed)) === null || _a === void 0 ? void 0 : _a.updateValue(this.deviceAdapter.fromCubyFanMode(this.stateManager.acState.fan));
            }
        }
        catch (error) {
